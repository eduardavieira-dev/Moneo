document.addEventListener("DOMContentLoaded", () => {
  ...
  document
    .getElementById("btnEditarInfo")
    .addEventListener("click", habilitarEdicao);
  document
    .getElementById("btnSalvarInfo")
    .addEventListener("click", salvarEdicoes);
  document
    .getElementById("btnCancelarInfo")
    .addEventListener("click", cancelarEdicoes);
  document
    .getElementById("btnEditarSenha")
    .addEventListener("click", habilitarEdicaoSenha);
  document
    .getElementById("btnSalvarSenha")
    .addEventListener("click", salvarSenha);
  document
    .getElementById("btnCancelarSenha")
    .addEventListener("click", cancelarEdicoesSenha);
  document
    .getElementById("btnImagemPerfil")
    .addEventListener("click", habilitarEdicaoImagem);
  document
    .getElementById("btnSalvarImagem")
    .addEventListener("click", salvarImagemPerfil);
});
...
function atualizarUsuarioNoBanco(usuario) {
  ...
  fetch(url, {
    ...
    .then((response) => {
      if (!response.ok) {
        throw new Error(`Falha ao atualizar usuário: HTTP ${response.status}`);
      }
    ...
    .catch((error) => {
      ...
      alert(
        "Erro ao atualizar o usuário. Verifique sua conexão e tente novamente.",
      );
    });
}
